...
Product.create(:name =>'Pink Perfect Gift',:category_id =>'2',:description=>'What do we do when we want to show our thankfulness? We send a card, a gift or something like that. ..',:image=>'http://localhost:3000/assets/loveandromance/pro_07',:price=>'21.60',:status => false)
...
Product.create(:name =>'Vera Wang Purest Grace',:category_id =>'2',:description=>'What do we do when we want to show our thankfulness? We send a card, a gift or something like that. ..',:image=>'http://localhost:3000/assets/loveandromance/pro_09',:price=>'88.00',:status => false)
...
Product.create(:name =>'Heavenly Red Rose Hand tied',:category_id =>'2',:description=>'What do we do when we want to show our thankfulness? We send a card, a gift or something like that. ..',:image=>'http://localhost:3000/assets/loveandromance/pro_11',:price=>'32.00',:status => false)
...
Product.create(:name =>'Autumn Basket',:category_id =>'3',:description=>'What do we do when we want to show our thankfulness? We send a card, a gift or something like that. ..',:image=>'http://localhost:3000/assets/sympathy/pro_14',:price=>'20.00 ',:status => false)
...
Product.create(:name =>'Happy Birthday Kalanchoe Basket',:category_id =>'3',:description=>'What do we do when we want to show our thankfulness? We send a card, a gift or something like that. ..',:image=>'http://localhost:3000/assets/sympathy/pro_016',:price=>'32.40 ',:status => false)
Product.create(:name =>'Mixed Basket Pink and Lilac',:category_id =>'3',:description=>'What do we do when we want to show our thankfulness? We send a card, a gift or something like that. ..',:image=>'http://localhost:3000/assets/sympathy/pro_017',:price=>'27.00 ',:status => false)

Product.create(:name =>'New Baby Flower',:category_id =>'4',:description=>'What do we do when we want to show our thankfulness? We send a card, a gift or something like that. ..',:image=>'http://localhost:3000/assets/newbaby/pro_18',:price=>'32.00 ')
