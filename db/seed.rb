...
Product.create(:name =>'Vera Wang Purest Grace',:category_id =>'2',:description=>'What do we do when we want c to show our thankfulness? We send a card, a gift or something like that. ..',:image=>'pro_09',:price=>'88.00',:status => false)
...
5.times do |n|
  ...
  User.create! name:  Faker::Name.name, email: Faker::Internet.email, password: password, password_confirmation: password,
    phone: Faker::PhoneNumber.cell_phone, address: Faker::Address.street_address, avatar: Faker::Avatar.image("my-own-slug", "50x50", "jpg")
end
