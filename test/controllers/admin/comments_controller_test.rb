...
class Admin::CommentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_comment" do
    assert_difference('Admin::Comment.count') do
      post admin_comments_url, params: { admin_comment: { comment_id: @admin_comment.comment_id, content: @admin_comment.content, user_id: @admin_comment.user_id } }
    end
  ...
  test "should update admin_comment" do
    patch admin_comment_url(@admin_comment), params: { admin_comment: { comment_id: @admin_comment.comment_id, content: @admin_comment.content, user_id: @admin_comment.user_id } }
