...
class Admin::OrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_order" do
    assert_difference('Admin::Order.count') do
      post admin_orders_url, params: { admin_order: { address: @admin_order.address, phonenumber: @admin_order.phonenumber, requirement: @admin_order.requirement, status: @admin_order.status, user_id: @admin_order.user_id } }
    end
  ...
  test "should update admin_order" do
    patch admin_order_url(@admin_order), params: { admin_order: { address: @admin_order.address, phonenumber: @admin_order.phonenumber, requirement: @admin_order.requirement, status: @admin_order.status, user_id: @admin_order.user_id } }
