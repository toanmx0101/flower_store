...
class Admin::ProductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_product" do
    assert_difference('Admin::Product.count') do
      post admin_products_url, params: { admin_product: { category_id: @admin_product.category_id, description: @admin_product.description, image: @admin_product.image, name: @admin_product.name, price: @admin_product.price, rate: @admin_product.rate, status: @admin_product.status } }
    end
  ...
  test "should update admin_product" do
    patch admin_product_url(@admin_product), params: { admin_product: { category_id: @admin_product.category_id, description: @admin_product.description, image: @admin_product.image, name: @admin_product.name, price: @admin_product.price, rate: @admin_product.rate, status: @admin_product.status } }
